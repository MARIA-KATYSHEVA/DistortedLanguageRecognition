...
if __name__ == '__main__':
    ...
    PATH_TO_VOCODER_MODEL = os.path.join(MODELS_DIR, "BigVGAN", "best.pt") #None - previos variant
    PATH_TO_REFERENCE_SPEAKER = "/home..."  # audios/speaker_references_for_testing/female_high_voice.wav
    LANGUAGE = "en"
